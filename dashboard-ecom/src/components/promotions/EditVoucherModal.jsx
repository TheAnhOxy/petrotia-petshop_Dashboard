...
export default function EditVoucherModal({ darkMode, voucher, onClose, onSave }) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        <div className="flex-shrink-0 bg-[#7b4f35] text-white px-6 py-4 flex items-center justify-between rounded-t-xl">
          <h3 className="text-xl font-bold">Chỉnh sửa Voucher</h3>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          <form onSubmit={handleSubmit} id="edit-voucher-form">
            <div className="mb-4">
