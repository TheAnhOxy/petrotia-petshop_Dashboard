...
export default function AddPromotionModal({ darkMode, onClose, onSave }) {
  const categories = [
  ...
  const [formData, setFormData] = useState({
    ...
    discountValue: "",
    categoryId: null, // Đổi từ applicableProducts thành categoryId
    startDate: "",
    endDate: "",
    status: "active",
    image: "",
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        <div className="flex-shrink-0 bg-[#7b4f35] text-white px-6 py-4 flex items-center justify-between rounded-t-xl">
          <h3 className="text-xl font-bold">Thêm Khuyến mãi Mới</h3>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          <form onSubmit={handleSubmit} id="add-promotion-form">
            <div className="mb-4">
              ...
              {formData.discountType !== "buy_x_get_y" && (
                <div>
                  ...
                  <input
                    ...
                    placeholder={formData.discountType === "percentage" ? "30" : "100000"}
                  />
                </div>
              )}
